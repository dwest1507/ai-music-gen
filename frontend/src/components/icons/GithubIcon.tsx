...
/**
 * GitHub mark, kept local because lucide-react v1 removed every brand icon.
 * Filled rather than stroked, so it takes `className` for sizing and inherits
 * color from the surrounding text like the lucide icons it sits beside.
 */
