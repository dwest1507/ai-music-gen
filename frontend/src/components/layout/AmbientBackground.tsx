/**
 * Fixed, non-interactive atmosphere layer: a base radial gradient plus a few
 * slowly drifting blurred colour pools. Sits behind all page content.
 */
export function AmbientBackground() {
    return (
        <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
            ...
            />
            {/* Secondary blob — upper left, violet/pink */}
            <div
            ...
            />
            {/* Bottom accent — subtle glow near the footer */}
            <div
